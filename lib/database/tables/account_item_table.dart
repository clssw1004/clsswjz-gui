...
class AccountItemTable extends BaseBusinessTable {
  ...
  static AccountItemTableCompanion toUpdateCompanion(
    ...
    return AccountItemTableCompanion(
      ...
      amount: nullIfAbsent(amount),
      description: nullIfAbsent(description),
      type: nullIfAbsent(type),
      categoryCode: nullIfAbsent(categoryCode),
      accountDate: nullIfAbsent(accountDate),
      accountBookId: nullIfAbsent(accountBookId),
      fundId: nullIfAbsent(fundId),
      shopCode: nullIfAbsent(shopCode),
      tagCode: nullIfAbsent(tagCode),
      projectCode: nullIfAbsent(projectCode),
